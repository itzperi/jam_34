...
const HeroSection: React.FC = () => {
  return (
    <section className="relative bg-forest paper-grain text-white overflow-hidden min-h-[600px] lg:min-h-[750px] flex items-center">
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-10 grid lg:grid-cols-2 items-center gap-12 lg:gap-16 w-full py-12 lg:py-20 relative z-10">
        <div className="space-y-8 lg:space-y-10 text-center lg:text-left">
          <h1 className="text-5xl md:text-6xl lg:text-8xl font-serif leading-[1.1]">
            125 Years of Nurturing Wellness
          </h1>
          <p className="text-lg md:text-xl lg:text-2xl opacity-80 max-w-xl mx-auto lg:mx-0 font-dm leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row flex-wrap gap-4 sm:gap-6 pt-4 justify-center lg:justify-start">
            <Link to="/shop" className="w-full sm:w-auto px-8 py-4 lg:px-10 lg:py-5 bg-saffron text-white font-bold text-base lg:text-lg rounded-full hover:bg-white hover:text-forest transition-all duration-300 shadow-xl shadow-black/20 text-center">
              Shop the Collection
            </Link>
            <button className="w-full sm:w-auto px-8 py-4 lg:px-10 lg:py-5 border border-white/30 text-white font-bold text-base lg:text-lg rounded-full hover:bg-white/10 transition-all">
              Our Heritage
            </button>
          </div>
        </div>
